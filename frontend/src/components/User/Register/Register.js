...
const formikSchema =Yup.object({
    name: Yup.string().matches(/^[a-z]+$/, "Must be only string").required('Name is required').min(2, 'Too Short!')
    .max(50, 'Too Long!'),
...
function Register() {
  ...
  return (
    <>
    <section className=" relative py-10  bg-w-900 overflow-hidden">
    {/* 2xl:py-40 */}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center -mx-4">
            <div className=" w-full  lg:w-2/5 px-4">
              <div className="px-6 lg:px-12 py-12 lg:py-15 bg-gray-800 shadow-lg rounded-lg">
                {/* Form */}
                <form 
              ...
              <div className="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                ...
                {appErr||serverErr ?  <div className='text-red-400 mt-4 text-align: center'>
                  {/* {serverErr} */}
                  {appErr}
              </div>:null}
              </div>
            ...
            <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last">
              ...
              <h2 className="text-center text-4xl lg:text-5xl text-black font-bold font-heading">
