          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className=" w-full  lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-20 bg-gray-800 shadow-lg rounded-lg">
                  {/* Form */}
                  <form 
                  ...
                  >
                    Login
                          ...
                          {appErr||serverErr ?  <div className='text-red-400 mt-5'>
                    {/* {serverErr} */}
                    {appErr}
                </div>:null}
                </div>
              ...
              <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last">
                ...
                <h2 className="text-center text-6xl lg:text-7xl text-black font-bold font-heading">
