...
import { fetchPostAction } from "../../Redux/Slices/posts/postSlice";
            ...
            <div class="flex flex-wrap -mx-3">
              <div class="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div class="py-4 px-6 bg-gray-600 shadow rounded">
                  ...
                  <ul>
                    {catLoading ? (<h1>Loading</h1>):catappErr || catserverErr ? (<h1>{catappErr}{catserverErr}</h1>):
                    categoryList?.lenght <=0 ? (<h1>No category Found</h1>):(categoryList?.map(category =>(
                    <li>
              ...
              <div class="w-full lg:w-3/4 px-3">
                {/* post here */}
                {loading ? <h1 className="text-4xl text-gray-300 lg:text-5xl font-bold">Loading</h1>:appErr || serverErr ? <h1>{appErr} {serverErr}</h1>:postList?.length <=0 ? <h1 className='text-4xl text-gray-300 lg:text-5xl font-bold'>No Post Found</h1>:postList?.map((post)=>(
                  ...
                  <div class="mb-10  w-full lg:w-1/4 px-3">
                    ...
                    <div className="flex flex-row bg-gray-300 justify-center w-full  items-center ">
                      ...
                      <div className="flex flex-row justify-center items-center ml-4 mr-4 pb-2 pt-1">
                        ...
                        <div className="pl-2 text-gray-600">{post?.likes?.lenght ? post?.likes?.lenght:0}</div>
                      </div>
                      {/* Dislike */}
                      <div className="flex flex-row  justify-center items-center ml-4 mr-4 pb-2 pt-1">
                        <div>
                        ...
                        <div className="pl-2 text-gray-600">{post?.dislikes?.lenght ? post?.dislikes?.lenght:0}</div>
                      </div>
                      {/* Views */}
                      <div className="flex flex-row justify-center items-center ml-4 mr-4 pb-2 pt-1">
                        <div>
                        ...
                        <div className="pl-2 text-gray-600">
                          {post?.numViews?.lenght ? post?.numViews?.lenght:0}
                        </div>
                      </div>
                    </div>
                  </div>
